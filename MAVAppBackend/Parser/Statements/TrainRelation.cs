...
namespace MAVAppBackend.Parser.Statements
{
    public class TrainRelation : ParserStatement
    {
        ...
        public TrainRelation(APIResponse origin, TrainIdentification id, StationIdentification from, StationIdentification to, TrainType type)
            : base(origin)
        {
            Id = id;
            From = from;
        ...
        public override IEnumerable<ParserStatement> GetSpawnedStatements()
        {
            yield return new TrainStationLink(Origin, Id, From, To, false);
        }
    }
}
